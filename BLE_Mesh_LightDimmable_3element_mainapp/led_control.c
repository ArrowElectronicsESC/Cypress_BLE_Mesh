 ...
 *                                Constants
 ******************************************************************************/
#define PWM_CHANNEL_BLUE        PWM0
#define PWM_CHANNEL_GREEN       PWM1
#define PWM_CHANNEL_RED         PWM2
...
void led_control_init(void)
{
    pwm_config_t pwm_config;
    	...
    	wiced_hal_gpio_select_function(WICED_GPIO_PIN_LED_2, WICED_PWM2);
        ...
        wiced_hal_pwm_start(PWM_CHANNEL_BLUE, PMU_CLK, pwm_config.toggle_count, pwm_config.init_count, 1);
}
...
void led_control_set_brighness_level(led_control_t whichLED, uint8_t brightness_level)
{
    ...
    switch(whichLED)
    {
    	...
    	case BLUE:
    		WICED_BT_TRACE("LED Control Brightness - SET BLUE BRIGHTNESS \r\n");
    		wiced_hal_pwm_change_values(PWM_CHANNEL_BLUE, pwm_config.toggle_count, pwm_config.init_count);
		break;
