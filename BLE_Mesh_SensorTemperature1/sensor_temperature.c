...
wiced_timer_t mesh_red_sensor_cadence_timer;
...
void mesh_app_init(wiced_bool_t is_provisioned)
{
    ...
    wiced_bt_cfg_settings.device_name = (uint8_t *)" MFR Temp Sensor";
    wiced_bt_cfg_settings.gatt_cfg.appearance = APPEARANCE_SENSOR_COLOR_LIGHT;
    ...
    mesh_red_sensor_sent_value[0] = (uint8_t)mesh_sensor_red_sensor;
    ...
    wiced_init_timer(&mesh_red_sensor_cadence_timer,
    ...
    mesh_red_sensor_sent_value[0] = (uint8_t)mesh_sensor_red_sensor;
    mesh_red_sensor_sent_value[1] = (uint8_t)mesh_sensor_green_sensor;
    mesh_red_sensor_sent_value[2] = (uint8_t)mesh_sensor_blue_sensor;
