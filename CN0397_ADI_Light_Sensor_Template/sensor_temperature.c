...
//TODO
//***********************************************
// ****** Add The Red Sensor defines here *******
//***********************************************
...
#define CLK_1        	WICED_Pxx
#define MISO_1          WICED_Pxx
#define MOSI_1          WICED_Pxx
#define CS_1            WICED_Pxx
...
// TODO
/********  CREEATE Red Sensor send variable here **********/
														// Ambient Light Sensor Element required 3 octets
...
/* Copy this section to create a Red Sensor Element */
...
/* Paste Copied Temperature Sensor Element here and modify to Red Sensor values */
 ...
 *   also make sure the you add the #define after this for the MESH_APP_NUM_MDDELS - give it a unique name */
...
wiced_bt_mesh_core_config_element_t mesh_elements[] =
{
	...
	//TODO
	/* Add the 2nd element here - copy the temperature above and modify for the red light sensor  */
};
...
void mesh_app_init(wiced_bool_t is_provisioned)
{
    ...
    //restore the cadence for the temperature sensor from NVRAM
    wiced_hal_read_nvram(MESH_TEMPERATURE_SENSOR_CADENCE_NVRAM_ID, sizeof(wiced_bt_mesh_sensor_config_cadence_t), (uint8_t*)(&p_sensor->cadence), &result);

    // TODO
    // restore the cadence for the Red Light Sensor from NVRAM
    // copy the temperature sensor init from above  and change the NVRAM_ID to the Red Sensor

    // init the temperature  sensor server
    ...
    // TODO
    /*******************************************************/
    /**** Add code to init the red light server ************/
    /*******************************************************/
...
void mesh_red_sensor_publish_timer_callback(TIMER_PARAM_TYPE arg)
{
    ...
    CN0397_ReadData( &mesh_sensor_red_sensor, &mesh_sensor_green_sensor, &mesh_sensor_blue_sensor);
