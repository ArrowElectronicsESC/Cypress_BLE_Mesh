...
CY_EXAMPLE_NAME = template_for_basic_projects

CY_EXAMPLE_DESCRIPTION = Template project for blinkled & blinkled_print on the CYW920819EVB-02 or CYBT-213043 kit that starts the Bluetooth stack and creates an RTOS thread for user code to test peripherals like GPIO, UART, ADC and so on.
